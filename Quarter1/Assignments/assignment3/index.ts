...
const username: string = "sigma65@gmail.com";
const password: string = "sigmapass65";
let output: string;
switch (true) {
...
let transactionType: string = "Withdraw";
let message: string;
